...
Two mechanisms, and the control that makes their comparison meaningful:
...
the matched cell condition removes exactly that many. Any residual difference is
attributable to the structure of the loss, not its amount.
